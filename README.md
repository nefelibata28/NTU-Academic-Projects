...
- **Year 2** – SC1007 (Data Structures & Algorithms), SC2001 (Algorithm Design & Analysis), SC2002 (Object Oriented Design & Programming), SC2006(Software Engineering), SC2008 (Computer Network), SC2207 (Introduction to Databases)
- **Year 3** – SC2079(Multidisciplinary Design Project ), SC3000 (Artificial Intelligence ), SC3010 (Computing Security), SC4000 (Machine Learning), SC4020 (Data Analytics and Mining )
