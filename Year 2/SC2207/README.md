...
- Implemented the database using SQL on MS SQL Server
- Developed and executed complex SQL queries to support analytical requirements
...
- Map the ER model to a relational schema
...
## What I Learned
- Translating textual requirements into accurate ER diagrams
- Applying database normalization principles
- Designing schemas that support complex SQL queries
